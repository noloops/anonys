...
#ifndef EXAMPLE1_ANONYS_HANDLERS_LEDJUGGLER_H
#define EXAMPLE1_ANONYS_HANDLERS_LEDJUGGLER_H

#include "anonys/Types.h"
#include "anonys/Utils.h"

#include "terminalsLedJuggler.h"
...
namespace anonys_1_8 {
    uint16_t getMembersSize();
    void liveCycle(bool create, void* pTerminals, void* pMembers);
    const anonys::StateDef* handleEvent(void* pMembers, anonys::Event& event);
}

namespace anonys_1_9 {
    uint16_t getMembersSize();
    void liveCycle(bool create, void* pTerminals, void* pMembers);
    const anonys::StateDef* handleEvent(void* pMembers, anonys::Event& event);
}
...
#endif // EXAMPLE1_ANONYS_HANDLERS_LEDJUGGLER_H
