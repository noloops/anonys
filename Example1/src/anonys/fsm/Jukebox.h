...
namespace anonys::fsm {
	struct Jukebox {
		...
		static constexpr anonys::StateDef On = { 8, anonys::FsmId::Jukebox, nullptr, anonys_0_8::getMembersSize, anonys_0_8::liveCycle, anonys_0_8::handleEvent };
		static constexpr anonys::StateDef Idle = { 2, anonys::FsmId::Jukebox, &On, anonys_0_2::getMembersSize, anonys_0_2::liveCycle, anonys_0_2::handleEvent };
		static constexpr anonys::StateDef Playing = { 3, anonys::FsmId::Jukebox, &On, anonys_0_3::getMembersSize, anonys_0_3::liveCycle, anonys_0_3::handleEvent };
