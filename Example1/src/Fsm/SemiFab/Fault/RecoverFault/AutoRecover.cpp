...
namespace {
    ...
    anonys::State* handle(Me& me, const evt::sys::WarmRestart& event) {
        return nullptr;
    }
...
namespace anonys_0_290 {
    anonys::State* handleEvent(void* pMembers, anonys::Event& event) {
        Me& me{ *static_cast<Me*>(pMembers) };
        switch (event.eventId.id) {
        case anonys::getEventId<evt::sys::WarmRestart>().id:
            return handle(me, *static_cast<evt::sys::WarmRestart*>(event.pData));
