...
namespace {
    ...
    anonys::State* handle(Me& me, const evt::dep::ChamberVented& event) {
        return nullptr;
    }
...
namespace anonys_0_63 {
    anonys::State* handleEvent(void* pMembers, anonys::Event& event) {
        ...
        case anonys::getEventId<evt::dep::ChamberVented>().id:
            return handle(me, *static_cast<evt::dep::ChamberVented*>(event.pData));
    ...
    void liveCycle(bool create, void* pTerminals, void* pMembers) {
        ...
        if (create) {
            Me& me{ *::new (pMembers) Me{ *terminals.pTimer, *terminals.pStd, *terminals.pGasCtrl, *terminals.pPressureCtrl } };
            enter(me);
        }
        else {
            Me& me{ *static_cast<Me*>(pMembers) };
