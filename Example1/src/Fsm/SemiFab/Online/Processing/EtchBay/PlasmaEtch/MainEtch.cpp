...
namespace {
    ...
    anonys::State* handle(Me& me, evt::etch::GasFlowSet& event) {
        return nullptr;
    }
...
namespace anonys_0_56 {
    anonys::State* handleEvent(void* pMembers, anonys::Event& event) {
        ...
        case anonys::getEventId<evt::etch::GasFlowSet>().id:
            return handle(me, *static_cast<evt::etch::GasFlowSet*>(event.pData));
    ...
    void liveCycle(bool create, void* pTerminals, void* pMembers) {
        ...
        if (create) {
            Me& me{ *::new (pMembers) Me{ *terminals.pTimer, *terminals.pStd, *terminals.pPlasmaGen, *terminals.pGasCtrl, *terminals.pEndpoint } };
            enter(me);
        }
        else {
            Me& me{ *static_cast<Me*>(pMembers) };
