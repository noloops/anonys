...
namespace {
    ...
    anonys::State* handle(Me& me, evt::etch::PressureSet& event) {
        return nullptr;
    }
...
namespace anonys_0_52 {
    anonys::State* handleEvent(void* pMembers, anonys::Event& event) {
        Me& me{ *static_cast<Me*>(pMembers) };
        switch (event.eventId.id) {
        case anonys::getEventId<evt::etch::PressureSet>().id:
            return handle(me, *static_cast<evt::etch::PressureSet*>(event.pData));
