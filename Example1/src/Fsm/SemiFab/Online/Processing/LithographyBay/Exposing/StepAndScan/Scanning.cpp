...
namespace {
    ...
    anonys::State* handle(Me& me, const evt::litho::FocusLocked& event) {
        return nullptr;
    }
...
namespace anonys_0_35 {
    anonys::State* handleEvent(void* pMembers, anonys::Event& event) {
        ...
        case anonys::getEventId<evt::litho::FocusLocked>().id:
            return handle(me, *static_cast<evt::litho::FocusLocked*>(event.pData));
    ...
    void liveCycle(bool create, void* pTerminals, void* pMembers) {
        ...
        if (create) {
            Me& me{ *::new (pMembers) Me{ *terminals.pTimer, *terminals.pStd, *terminals.pScanner, *terminals.pFocusUnit } };
            enter(me);
        }
        else {
            Me& me{ *static_cast<Me*>(pMembers) };
