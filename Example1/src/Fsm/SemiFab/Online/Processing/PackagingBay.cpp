...
namespace {
    ...
    anonys::State* handle(Me& me, const evt::pkg::BondStart& event) {
        return nullptr;
    }
...
namespace anonys_0_194 {
    anonys::State* handleEvent(void* pMembers, anonys::Event& event) {
        Me& me{ *static_cast<Me*>(pMembers) };
        switch (event.eventId.id) {
        case anonys::getEventId<evt::pkg::BondStart>().id:
            return handle(me, *static_cast<evt::pkg::BondStart*>(event.pData));
    ...
    void liveCycle(bool create, void* pTerminals, void* pMembers) {
        ...
        if (create) {
            ...
            terminals.pBonder = &me.bonder;
            terminals.pDicer = &me.dicer;
            enter(me);
        }
        else {
            Me& me{ *static_cast<Me*>(pMembers) };
            exit(me);
            me.~Me();
            terminals.pBonder = nullptr;
            terminals.pDicer = nullptr;
        }
    }
