...
namespace {
    ...
    anonys::State* handle(Me& me, const evt::thermal::OxidationStart& event) {
        return nullptr;
    }

    anonys::State* handle(Me& me, const evt::thermal::OxidationDone& event) {
        return nullptr;
    }
}

// ANONYS - Generated code – do not edit the rest of this file!
namespace anonys_0_138 {
    anonys::State* handleEvent(void* pMembers, anonys::Event& event) {
        Me& me{ *static_cast<Me*>(pMembers) };
        switch (event.eventId.id) {
        case anonys::getEventId<evt::thermal::OxidationStart>().id:
            return handle(me, *static_cast<evt::thermal::OxidationStart*>(event.pData));
        case anonys::getEventId<evt::thermal::OxidationDone>().id:
            return handle(me, *static_cast<evt::thermal::OxidationDone*>(event.pData));
        default:
