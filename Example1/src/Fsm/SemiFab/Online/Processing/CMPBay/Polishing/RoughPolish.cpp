...
namespace {
    ...
    anonys::State* handle(Me& me, evt::cmp::DownForceSet& event) {
        return nullptr;
    }
...
namespace anonys_0_95 {
    anonys::State* handleEvent(void* pMembers, anonys::Event& event) {
        ...
        case anonys::getEventId<evt::cmp::DownForceSet>().id:
            return handle(me, *static_cast<evt::cmp::DownForceSet*>(event.pData));
