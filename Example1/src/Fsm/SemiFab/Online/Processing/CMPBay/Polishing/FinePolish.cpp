...
namespace {
    ...
    anonys::State* handle(Me& me, evt::cmp::SlurryFlowSet& event) {
        return nullptr;
    }
...
namespace anonys_0_98 {
    anonys::State* handleEvent(void* pMembers, anonys::Event& event) {
        ...
        case anonys::getEventId<evt::cmp::SlurryFlowSet>().id:
            return handle(me, *static_cast<evt::cmp::SlurryFlowSet*>(event.pData));
    ...
    void liveCycle(bool create, void* pTerminals, void* pMembers) {
        ...
        if (create) {
            Me& me{ *::new (pMembers) Me{ *terminals.pTimer, *terminals.pStd, *terminals.pPolishHead, *terminals.pSlurryPump, *terminals.pCmpEndpoint } };
            enter(me);
        }
        else {
            Me& me{ *static_cast<Me*>(pMembers) };
