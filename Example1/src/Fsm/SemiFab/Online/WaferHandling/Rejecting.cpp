...
namespace {
    ...
    anonys::State* handle(Me& me, const evt::wafer::WaferReject& event) {
        return nullptr;
    }
...
namespace anonys_0_25 {
    anonys::State* handleEvent(void* pMembers, anonys::Event& event) {
        Me& me{ *static_cast<Me*>(pMembers) };
        switch (event.eventId.id) {
        case anonys::getEventId<evt::wafer::WaferReject>().id:
            return handle(me, *static_cast<evt::wafer::WaferReject*>(event.pData));
