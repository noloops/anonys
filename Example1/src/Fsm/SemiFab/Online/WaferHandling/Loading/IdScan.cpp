...
namespace {
    ...
    anonys::State* handle(Me& me, evt::wafer::WaferIdScanned& event) {
        return nullptr;
    }
...
namespace anonys_0_16 {
    anonys::State* handleEvent(void* pMembers, anonys::Event& event) {
        Me& me{ *static_cast<Me*>(pMembers) };
        switch (event.eventId.id) {
        case anonys::getEventId<evt::wafer::WaferIdScanned>().id:
            return handle(me, *static_cast<evt::wafer::WaferIdScanned*>(event.pData));
