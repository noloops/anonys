...
namespace {
    ...
    anonys::State* handle(Me& me, const evt::wafer::WaferUnloaded& event) {
        return nullptr;
    }
...
namespace anonys_0_22 {
    anonys::State* handleEvent(void* pMembers, anonys::Event& event) {
        Me& me{ *static_cast<Me*>(pMembers) };
        switch (event.eventId.id) {
        case anonys::getEventId<evt::wafer::WaferUnloaded>().id:
            return handle(me, *static_cast<evt::wafer::WaferUnloaded*>(event.pData));
