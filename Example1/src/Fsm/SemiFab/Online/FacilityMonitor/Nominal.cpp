...
namespace anonys_0_238 {
    ...
    void liveCycle(bool create, void* pTerminals, void* pMembers) {
        ...
        if (create) {
            Me& me{ *::new (pMembers) Me{ *terminals.pTimer, *terminals.pStd, *terminals.pPanel, *terminals.pPressureSensor, *terminals.pFlowSensor, *terminals.pParticleSensor, *terminals.pTempSensor } };
            enter(me);
        }
        else {
            Me& me{ *static_cast<Me*>(pMembers) };
