...
namespace anonys_0_248 {
    ...
    void liveCycle(bool create, void* pTerminals, void* pMembers) {
        ...
        if (create) {
            Me& me{ *::new (pMembers) Me{ *terminals.pStd, *terminals.pPanel, *terminals.pTempSensor, *terminals.pPressureSensor, *terminals.pFlowSensor, *terminals.pParticleSensor } };
            enter(me);
        }
        else {
            Me& me{ *static_cast<Me*>(pMembers) };
