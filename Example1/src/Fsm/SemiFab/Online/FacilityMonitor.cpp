...
namespace {
    ...
    struct Me {
        ...
        term::sensor::FlowSensor flowSensor{};
        term::sensor::ParticleSensor particleSensor{};
...
namespace anonys_0_237 {
    ...
    void liveCycle(bool create, void* pTerminals, void* pMembers) {
        ...
        if (create) {
            Me& me{ *::new (pMembers) Me{ *terminals.pStd, *terminals.pPanel } };
            terminals.pPressureSensor = &me.pressureSensor;
            terminals.pFlowSensor = &me.flowSensor;
            terminals.pParticleSensor = &me.particleSensor;
            terminals.pTempSensor = &me.tempSensor;
            enter(me);
        }
        else {
            Me& me{ *static_cast<Me*>(pMembers) };
            exit(me);
            me.~Me();
            terminals.pPressureSensor = nullptr;
            terminals.pFlowSensor = nullptr;
            terminals.pParticleSensor = nullptr;
            terminals.pTempSensor = nullptr;
        }
    }
